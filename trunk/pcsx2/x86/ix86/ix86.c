...
_inline void ModRM( s32 mod, s32 reg, s32 rm )
{	
	write8( ( mod << 6 ) | ( (reg & 7) << 3 ) | ( rm & 7 ) );
}

_inline void SibSB( s32 ss, s32 index, s32 base )
{
...
_inline void ADD32ItoRmOffset( x86IntRegType to, u32 from, s32 offset)
{
	RexB(0,to);
	if(from < 0x80)
	{
